...
export const PLAN_TO_PRICE_MAP: Record<string, string> = {
  ...
  [PLAN_IDS.STARTER]: 'price_1QzuV407Sez9m06J0x9IUqhR',   // Starter plan
  [PLAN_IDS.PRO]: 'price_1QzuVA07Sez9m06JbNwIzPcV',       // Pro plan
  [PLAN_IDS.ENTERPRISE]: 'price_1QzueA07Sez9m06JkNgQEjoH'  // Enterprise plan
};
